...
- [x] 1. Configure Xcode project with SwiftTerm dependency, design system tokens, and custom fonts
...
- [x] 2. Service layer: domain types, protocol, and mock implementation
- [x] 2.1 Define all domain types and the SbxServiceProtocol contract
...
- [x] 2.2 Implement the mock service actor with full lifecycle, policy, and port operations
...
- [x] 2.3 (P) Implement MockPtyEmitter for simulated terminal output
...
- [x] 2.4 Write unit tests for the mock service and mock emitter
...
- [x] 3. Service factory and app-level dependency injection
...
- [x] 4. Build application shell with NavigationSplitView and sidebar
...
- [x] 5. Sandbox dashboard and project creation
- [x] 5.1 Implement SandboxStore with polling and mutation actions
...
- [x] 5.2 Build the dashboard grid with sandbox cards, status indicators, and statistics
...
- [x] 5.3 Build project creation sheet with directory picker and optional name
...
- [x] 6. Add sandbox lifecycle controls to dashboard cards
...
- [x] 7. Network policy management
- [x] 7.1 (P) Implement PolicyStore and build policy panel with rule management
...
- [x] 7.2 Build policy log viewer with filtering
...
- [x] 8. (P) Port forwarding management
...
- [x] 9. PTY session manager and terminal view wrapper
- [x] 9.1 (P) Implement PtySessionManager actor
...
- [x] 9.2 Build TerminalViewWrapper as NSViewRepresentable
...
- [x] 10. Session interaction UI
- [x] 10.1 Build session panel with terminal view and chat input
...
- [x] 10.2 Implement SessionStore with lifecycle management and status display
...
- [x] 11. External terminal integration
- [x] 11.1 (P) Implement terminal application detection and shell launching
...
- [x] 11.2 Add terminal preference setting and wire the Open Shell action
...
- [x] 12. Real sbx CLI integration
- [x] 12.1 (P) Implement CLI executor and output parsers
...
- [x] 12.2 Implement RealSbxService wrapping all CLI commands
...
- [x] 13. Error handling, alert notifications, and input validation
...
- [x] 14. E2E test suite
- [x] 14.1 Set up XCUITest with mock mode injection
...
- [x] 14.2 (P) Write E2E tests for project creation and sandbox lifecycle
...
- [x] 14.3 (P) Write E2E tests for policies, ports, and session messaging

...
- [x] 1. Foundation — domain types, provider protocol, and path scope
...
- [x] 1.2 (P) Implement the default FileManager-backed provider
...
- [x] 2. EditorStore skeleton — lifecycle, state, and shared accessor
...
- [x] 3. File browsing and opening

- [x] 3.1 Implement workspace-rooted file tree listing
...
- [x] 3.2 Implement file-open with size classification and binary fallback
...
- [x] 4. Tab management, dirty pipeline, save, and summary
...
- [x] 6. App integration and mock-workspace wiring
...
- [x] 7.3 (P) Build the file tree view
...
- [x] 8. Split-pane container and shell integration

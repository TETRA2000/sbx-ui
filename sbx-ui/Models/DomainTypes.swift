...
public struct Sandbox: Identifiable, Sendable, Encodable {
    ...
    nonisolated public init(id: String, name: String, agent: String, status: SandboxStatus, workspace: String, ports: [PortMapping], createdAt: Date) {
...
public struct PolicyRule: Identifiable, Sendable, Encodable {
    ...
    nonisolated public init(id: String, type: String, decision: PolicyDecision, resources: String) {
...
public struct PolicyLogEntry: Sendable, Identifiable {
    ...
    nonisolated public init(sandbox: String, type: String, host: String, proxy: String, rule: String, lastSeen: Date, count: Int, blocked: Bool) {
...
public struct PortMapping: Sendable, Identifiable, Equatable, Encodable {
    ...
    nonisolated public init(hostPort: Int, sandboxPort: Int, protocolType: String) {
...
public struct RunOptions: Sendable {
    ...
    nonisolated public init(name: String? = nil, prompt: String? = nil) {
